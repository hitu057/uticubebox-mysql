const { verifyFaculty, startAttendance, stopAttendance, manualAttendance, autoAttendance, studentList, verifyStudent, viewAttendance, viewSingleAttendance } = require("./attendance.controller")
const router = require("express").Router()
const { checkToken } = require("../../auth/token-validation")
const { verifyFacultyValidation, startAttendanceValidation, stopAttendanceValidation, manualAttendanceValidation, autoAttendanceValidation, studentListValidation, verifyStudentValidation, viewAttendanceValidation ,viewSingleAttendanceValidation} = require("../../validation/attendance/attendance.validation")
...
router.post("/viewSingleAttendance", checkToken, viewSingleAttendanceValidation, viewSingleAttendance)
